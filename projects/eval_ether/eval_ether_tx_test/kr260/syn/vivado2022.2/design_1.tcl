...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {corel_reset} \
 ] $core_clk
  set corel_reset [ create_bd_port -dir O -from 0 -to 0 -type rst corel_reset ]
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {193.458} \
    CONFIG.CLKOUT1_PHASE_ERROR {223.218} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000} \
    CONFIG.CLKOUT2_JITTER {160.754} \
    CONFIG.CLKOUT2_PHASE_ERROR {223.218} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {570.000} \
    CONFIG.CLKOUT2_USED {true} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {45.625} \
...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports ether_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports core_clk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_ports ether_reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_ports corel_reset] [get_bd_pins proc_sys_reset_1/peripheral_reset]
