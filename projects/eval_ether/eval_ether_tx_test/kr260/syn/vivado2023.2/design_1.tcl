...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {ref_reset} \
 ] $ref_clk
  set ref_reset [ create_bd_port -dir O -from 0 -to 0 -type rst ref_reset ]
...
\
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {191.523} \
    CONFIG.CLKOUT1_PHASE_ERROR {223.191} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000} \
    CONFIG.CLKOUT2_JITTER {159.172} \
    CONFIG.CLKOUT2_PHASE_ERROR {223.191} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {580.000} \
    CONFIG.CLKOUT2_USED {true} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {46.250} \
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports in_clk25] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports ether_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_ports core_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_2/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_pins proc_sys_reset_1/peripheral_reset] [get_bd_ports core_reset]
  connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_pins proc_sys_reset_2/peripheral_reset] [get_bd_ports ref_reset]
  connect_bd_net -net ref_clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_ports ref_clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net reset_0_1 [get_bd_ports in_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins clk_wiz_1/reset] [get_bd_pins proc_sys_reset_2/ext_reset_in]
