...
#
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -min 0.000 [get_ports {rgmii0_tx_ctrl {rgmii0_tx_d[*]}}]
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -min 0.000 [get_ports {rgmii0_tx_ctrl {rgmii0_tx_d[*]}}] -clock_fall -add_delay
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -max 0.000 [get_ports {rgmii0_tx_ctrl {rgmii0_tx_d[*]}}]
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -max 0.000 [get_ports {rgmii0_tx_ctrl {rgmii0_tx_d[*]}}] -clock_fall -add_delay
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -min 0.000 [get_ports {rgmii1_tx_ctrl {rgmii1_tx_d[*]}}]
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -min 0.000 [get_ports {rgmii1_tx_ctrl {rgmii1_tx_d[*]}}] -clock_fall -add_delay
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -max 0.000 [get_ports {rgmii1_tx_ctrl {rgmii1_tx_d[*]}}]
#set_output_delay -clock [get_clocks clk_out1_design_1_clk_wiz_0_0] -max 0.000 [get_ports {rgmii1_tx_ctrl {rgmii1_tx_d[*]}}] -clock_fall -add_delay
