...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {97.951} \
    CONFIG.CLKOUT1_PHASE_ERROR {76.493} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {100} \
    CONFIG.CLKOUT2_JITTER {68.799} \
    CONFIG.CLKOUT2_PHASE_ERROR {76.493} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {738.00} \
    CONFIG.CLKOUT2_USED {true} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {14.750} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {14.750} \
...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports m_axi4l_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs m_axi4l/Reg] -force
