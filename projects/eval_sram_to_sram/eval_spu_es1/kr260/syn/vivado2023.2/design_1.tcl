...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {150.678} \
    CONFIG.CLKOUT1_PHASE_ERROR {180.236} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {166.6666} \
    CONFIG.CLKOUT2_JITTER {124.482} \
    CONFIG.CLKOUT2_PHASE_ERROR {180.236} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {585.000} \
    CONFIG.CLKOUT2_USED {true} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {35.000} \
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SPI 1#TTC 0#GPIO0 MIO#SPI 1#SPI 1#SPI 1#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0\
...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports m_axi4l_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_ports m_axi4l_aresetn]
